...
public class ShogunArmsCuriosRenderer implements ICurioRenderer {
  ...
  private final HumanoidModel humanoidModel;
	...
	@SuppressWarnings("rawtypes")
  public ShogunArmsCuriosRenderer() {
        Modelshogun_arms model = new Modelshogun_arms(Minecraft.getInstance().getEntityModels().bakeLayer(Modelshogun_arms.LAYER_LOCATION));
