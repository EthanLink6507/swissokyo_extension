...
public class MakaiWingsCuriosRenderer implements ICurioRenderer {
	private static final ResourceLocation TEXTURE = ResourceLocation.parse("swissokyo_addons:textures/entities/makai_wings.png");
